"""
Functions to handle registration of aigc_evals. To add a new eval to the registry,
...
from typing import Any, Iterator, Optional, Sequence, Type, TypeVar, Union, List, Dict

import openai
import yaml

from aigc_evals import OpenAIChatCompletionFn, OpenAICompletionFn
from aigc_evals.api import CompletionFn, DummyCompletionFn
from aigc_evals.base import BaseEvalSpec, CompletionFnSpec, EvalSetSpec, EvalSpec
from aigc_evals.elsuite.modelgraded.base import ModelGradedSpec
from aigc_evals.utils.misc import make_object
