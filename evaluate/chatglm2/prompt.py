...
from evaluate.chatglm2.infer import Engine_API
    ...
    def eval_subject(self, subject_name, test_df, dev_df=None, few_shot=False, cot=False, save_result_dir=None):
        ...
        for row_index, row in tqdm(test_df.iterrows(), total=len(test_df)):
            ...
            if few_shot:
                ...
                ans = self.generate_dist(question, do_sample=False,  repetition_penalty=1.01, max_new_tokens=1, history=history)
