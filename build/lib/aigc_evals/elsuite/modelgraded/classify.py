...
from aigc_evals.elsuite.modelgraded.classify_utils import classify, sample_and_concat_n_completions
from aigc_evals.elsuite.utils import PromptFn, scrub_formatting_from_prompt


class ModelBasedClassify(aigc_evals.Eval):
    def __init__(
        self,
    ...
    def eval_sample(self, test_sample: dict, rng: Random) -> None:
        ...
        aigc_evals.record.record_metrics(**metrics)
